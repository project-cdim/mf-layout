...
const LayoutStatus: APILayoutStatus = {
  ...
  design: {
    status: 'FAILED',
    code: 'E40005',
    message: 'Failed to execute LayoutDesign',
...
/**
 * APILayoutDetail
 * Response type definition of GET /layout-detail?/{designID}
 */
  ...
  procedure: [
    {
      ...
      applyResults: {
        ...
        //  Add IN_PROGRESS, is there also CANCELING? What about a pending execution state?
