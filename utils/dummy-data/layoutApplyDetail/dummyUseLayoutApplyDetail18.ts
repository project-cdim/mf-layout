...
export const dummyUseLayoutApplyDetail: ReturnType<typeof useLayoutApplyDetail> = {
  data: {
    ...
    apply: {
      status: 'CANCELED',
      startedAt: new Date('2024-08-06T04:43:38.000Z'),
      canceledAt: new Date('2024-08-06T04:43:41.000Z'),
    },
    rollback: {
      status: 'SUSPENDED',
      startedAt: new Date('2024-08-06T04:43:55.000Z'),
      suspendedAt: new Date('2024-08-06T04:43:59.000Z'),
    },
    procedures: [
      {
        operationID: 1,
