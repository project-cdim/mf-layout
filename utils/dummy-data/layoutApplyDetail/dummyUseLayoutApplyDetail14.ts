...
export const dummyUseLayoutApplyDetail: ReturnType<typeof useLayoutApplyDetail> = {
  data: {
    ...
    apply: {
      status: 'CANCELED',
      startedAt: new Date('2024-08-01T04:46:08.000Z'),
      canceledAt: new Date('2024-08-01T04:46:12.000Z'),
      endedAt: new Date('2024-08-01T04:46:45.000Z'),
    },
    rollback: {
      status: 'COMPLETED',
      startedAt: new Date('2024-08-01T04:46:38.000Z'),
      endedAt: new Date('2024-08-01T04:46:45.000Z'),
    },
    procedures: [
      {
