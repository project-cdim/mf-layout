...
// Apply : Completed + Resume Requested
export const dummyUseLayoutApplyDetail: ReturnType<typeof useLayoutApplyDetail> = {
  data: {
    applyID: 'a0f84fcba5',
    apply: {
      status: 'COMPLETED',
      startedAt: new Date('2024-07-17T02:43:51.000Z'),
      suspendedAt: new Date('2024-07-17T02:43:57.000Z'),
      resumedAt: new Date('2024-07-17T02:45:07.000Z'),
      endedAt: new Date('2024-07-17T02:45:45.000Z'),
    },
    procedures: [
      {
        operationID: 1,
