...
// Apply : Suspended + Resume Requested
export const dummyUseLayoutApplyDetail: ReturnType<typeof useLayoutApplyDetail> = {
  data: {
    applyID: '7faeb84c60',
    apply: {
      status: 'SUSPENDED',
      startedAt: new Date('2024-07-31T08:30:15.000Z'),
      suspendedAt: new Date('2024-07-31T08:30:49.000Z'),
      resumedAt: new Date('2024-07-31T08:30:44.000Z'),
    },
    procedures: [
      {
        operationID: 1,
