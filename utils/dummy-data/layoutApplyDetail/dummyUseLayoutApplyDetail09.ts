...
// Apply : Failed + Cancel Requested
export const dummyUseLayoutApplyDetail: ReturnType<typeof useLayoutApplyDetail> = {
  data: {
    applyID: 'defca59dcb',
    apply: {
      status: 'FAILED',
      startedAt: new Date('2024-08-01T07:44:12.000Z'),
      canceledAt: new Date('2024-08-01T07:44:13.000Z'),
      endedAt: new Date('2024-08-01T07:44:15.000Z'),
    },
    procedures: [
      {
        operationID: 1,
